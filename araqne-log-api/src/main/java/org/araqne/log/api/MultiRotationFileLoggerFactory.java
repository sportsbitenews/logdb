...
public class MultiRotationFileLoggerFactory extends AbstractLoggerFactory {
	...
	public Collection<LoggerConfigOption> getConfigOptions() {
		...
		LoggerConfigOption logBeginRegex = new MutableStringConfigType("begin_regex", t("Log begin regex", "로그 시작 구분 정규표현식",
		...
		LoggerConfigOption logEndRegex = new MutableStringConfigType("end_regex", t("Log end regex", "로그 끝 구분 정규표현식",
