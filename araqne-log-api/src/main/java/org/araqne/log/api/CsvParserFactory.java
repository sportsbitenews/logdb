...
public class CsvParserFactory extends AbstractLogParserFactory {
	...
	public Collection<LoggerConfigOption> getConfigOptions() {
		...
		options.add(new StringConfigType("use_tab", t("Use tab", "탭문자 사용 여부"),
				t("Use tab to delimiter. (true or false)", "구분자로 탭문자를 사용할지 결정합니다. true 혹은 false"), false));

		options.add(new StringConfigType("use_double_quote", t("Double quote escape", "큰 따옴표 이스케이프"),
				t("Use double quote to escape. (true or false)", "특수문자를 구분하기 위한 이스케이프 문자를 큰 따옴표로 사용합니다. true 혹은 false"), false));
