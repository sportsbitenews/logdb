...
public class RegexConfigType extends AbstractConfigType {

	public RegexConfigType(String name, Map<Locale, String> displayNames, Map<Locale, String> descriptions,
			boolean required) {
