...
import org.araqne.rss.impl.RssDateParser;
...
public class RssEntry {
	...
	public void setCreatedAt(Date createdAt) {
		if (createdAt == null) {
			...
			timeString = String.format("%02d:%02d:%02d", cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE),
	...
	public Map<String, Object> toMap() {
		...
		m.put("source", getSource());
		m.put("link", getLink());
		m.put("guid", getGuid());
		m.put("content", getContent());
		m.put("created_at", getCreatedAt());
		m.put("modified_at", getModifiedAt());
