 ...
 * @since 2.2.0
 */
public class GenianNacSysLogParser extends V1LogParser {
	private final Logger slog = LoggerFactory.getLogger(GenianNacSysLogParser.class);
	...
	public Map<String, Object> parse(Map<String, Object> log) {
		...
		try {
			...
			if (slog.isDebugEnabled())
				slog.debug("araqne syslog parser: geni networks nac syslog parse error - [" + line + "]", t);
			return log;
		}
	}
}
