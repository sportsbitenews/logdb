...
public class BufferedLocalFileInputStream implements DataInput, Closeable {
	...
	public BufferedLocalFileInputStream(FilePath path) throws IOException {
		this(path, BUFFER_SIZE);
	}
	
	public BufferedLocalFileInputStream(FilePath path, int bufSize) throws IOException {
