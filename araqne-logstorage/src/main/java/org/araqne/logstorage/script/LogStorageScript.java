...
import org.araqne.logstorage.IndexConfigSpec;
import org.araqne.logstorage.IndexTokenizerFactory;
...
public class LogStorageScript implements Script {
	...
	public void purgeIndexRange(String[] args) {
		...
		try {
			...
			logger.error("araqne logstorage: cannot purge index range, table=" + tableName + ", index=" + indexName, t);
		}
	}
	...
	public void createIndex(String[] args) {
		...
		try {
			...
			logger.error("araqne logstorage: cannot create index for table " + tableName, t);
		}
	}
