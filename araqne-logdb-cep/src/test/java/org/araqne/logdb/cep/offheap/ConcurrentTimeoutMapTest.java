...
public class ConcurrentTimeoutMapTest {
	private ConcurrentTimeoutMap<String, String> map;
	private ConcurrentTimeoutMap<EventKey, EventContext> map2;
	...
	@Before
	public void onStart() {
		map = ConcurrentTimeoutMapFactory.string(4, 1024, 256).map();
		map2 = ConcurrentTimeoutMapFactory.event(4, 1024, 512).map();
