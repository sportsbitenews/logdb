...
public class ProcedureInfo {
	...
	private List<ProcedureParameterInfo> parameters = new ArrayList<ProcedureParameterInfo>();
	...
	public List<ProcedureParameterInfo> getParameters() {
		return parameters;
	}

	public void setParameters(List<ProcedureParameterInfo> parameters) {
