...
import org.araqne.logdb.query.command.Append;
 ...
 * 
 */
public class AppendParser extends AbstractQueryCommandParser {

	private QueryParserService queryParserService;

	public AppendParser(QueryParserService queryParserService) {
	...
	public QueryCommand parse(QueryContext context, String commandString) {
		...
		Query subQuery = new DefaultQuery(context, subQueryString, subCommands, new BypassResultFactory(append));
		append.setSubQuery(subQuery);
		return append;
	}
