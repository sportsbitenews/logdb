...
public class WapplesSyslogParserTest {
	...
	public void testParser() {
		...
		assertEquals(
				"GET /event/service/appAuthTocb/appAuthTocbMain.mocb%7C65806?app_type=ios&mbr_id=g5SNUcBnDh2MxqeLZHI33g%3D%3D&CI_YN=Y HTTP/1.1 Host: m.okcashbag.com Accept-Encoding: gzip, deflate Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8 Cookie: cookie_id=201403101733369775393 Connection: keep-alive Accept-Language: ja-jp User-Agent: Mozilla/5.0 (iPhone; CPU iPhone OS 7_1 like Mac OS X) AppleWebKit/537.51.2 (KHTML, like Gecko) Mobile/11D167",
				m.get("raw_data"));
