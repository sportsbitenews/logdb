...
public class RecursiveDirectoryWatchLoggerFactory extends AbstractLoggerFactory {
	...
	public Collection<LoggerConfigOption> getConfigOptions() {
		...
		LoggerConfigOption dirPathPattern = new MutableStringConfigType("dirpath_pattern", t("Directory Path pattern",
				...
				"대상 로그 파일이 있는 디렉토리를 선택하는데 사용할 정규표현식", "対象ログファイルがあるディレクトリを選ぶとき使う正規表現", "表示要采集的文件所在目录的正则表达式"), false, "regex");
		...
		LoggerConfigOption newlogRegex = new MutableStringConfigType("newlog_designator", t("Regex for first line", "로그 시작 정규표현식",
